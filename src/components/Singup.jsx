...
const Signup = ({ isLoggedIn, setIsLoggedIn, profilePicture, userName, setUserName, profilePictureExist }) => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
        <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden mx-auto my-12" style={{ maxWidth: "80vw" }}>
          <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <div className="flex items-center">
                <p className="mr-3 my-0">Register as a</p>
                <label htmlFor="mentor" className="mr-3">
                  <input type="radio" name="accountType" id="mentor" value={'Mentor'} onChange={(e) => setAccountType(e.target.value)} /> Mentor
                </label>
                <label htmlFor="mentee">
                  <input type="radio" name="accountType" id="mentee" value={'Mentee'} onChange={(e) => setAccountType(e.target.value)} /> Mentee
                </label>
              </div>
            </div> */}
              <div>
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    ...
                    <div className="flex">
                      ...
                      <input type="text" value={userName} onChange={(e) => setUserName(e.target.value)} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John" />
                    </div>
                  </div>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    ...
                    <div className="flex">
                      ...
                      <input type="email" value={userEmail} onChange={(e) => setUserEmail(e.target.value)} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" />
                    </div>
                  </div>
                </div>
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-12">
                    ...
                    <div className="flex">
                      ...
                      <input type="password" value={userPassword} onChange={(e) => setUserPassword(e.target.value)} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                    </div>
                  </div>
                </div>
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" onClick={handleSingup}>REGISTER NOW</button>
                  </div>
                </div>
              </div>
            </div>
