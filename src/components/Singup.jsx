...
const Signup = () => {
  ...
  const { setIsLoggedIn, userName, setUserName } = useContext(Context);
  ...
  const handleSingup = () => {
    ...
    promise.then(
      function (response) {
        alert(
          `You've Successfully Signed Up, ${userName}!🥳 Please proceed to login`
        );
        setIsLoggedIn(true);
        navigate("/login");
      },
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
        <div
          className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden mx-auto my-12"
          style={{ maxWidth: "80vw" }}
        >
