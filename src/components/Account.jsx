  ...
  const handleSave = () => {
    ...
    if (accountType === "Mentor") {
      if (
        ...
        alert(
          "Please fill in all required fields for Mentors (Profile picture, Bio, Skills, Days and Time you're Available)."
        );
        return;
      }
    }
                ...
                <form>
                  ...
                  <div className="w-full mx-auto my-7 lg:w-6/12 px-4">
                    <div className="relative w-full mb-5">
                      <img
                        className="m-auto rounded-full mb-2 w-28 h-28"
                        src={
                          profilePictureExist
                            ? profilePicture
                        ...
                        alt="Profile"
                      />
                      {profilePictureExist ? null : (
                        <input
                          type="file"
                          accept=".jpg, .png, .jpeg"
                          onChange={(e) => handleSetProfilePicture(e)}
                          className="border-0 p-2 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring m-auto block ease-linear transition-all duration-150"
                        />
                      )}
                    </div>
                  </div>
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-6/12 px-4">
                      ...
                      <div className="relative w-full my-6">
                        ...
                        <label
                          htmlFor="mentor"
                          className="mr-3 ml-2 text-sm font-medium text-gray-700"
                        >
                          <input
                            type="radio"
                            name="accountType"
                      ...
                      {accountType === "Mentor" && (
                        <div className="relative w-full mt-5">
                          ...
                          <textarea
                            ...
                            value={mentorBio}
                            onChange={(e) =>
                              setMentorBio(e.target.value.slice(0, 38))
                            }
                            className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                            rows="4"
                            placeholder="A Software Development mentor | Ex - Amazon"
                          ></textarea>
                        </div>
                      )}
                    </div>
                      ...
                      <div className="relative w-full mb-3">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                          {interests.map((interest) => (
                            <div
                              key={interest.value}
                              className="flex items-center mb-1 mr-3"
                            >
                              <input
                                type="checkbox"
                                id={interest.value}
                          ...
                          <div className="relative w-full my-6">
                            <label className="block uppercase text-blueGray-600 text-xs font-bold mb-2">
                              ...
                              <span
                                ...
                                style={{ fontSize: "11px" }}
                              >
                                (select the days you will be mostly available):
                              </span>
                            </label>
                          ...
                          <div className="relative w-full mb-6">
                            <label className="block uppercase text-blueGray-600 text-xs font-bold mb-2">
                              ...
                              <span
                                ...
                                style={{ fontSize: "11px" }}
                              >
                                (select the time you will be mostly online):
                              </span>
                            </label>
                            <div className="flex items-center gap-10">
                              <div className="flex flex-col mb-2">
                                ...
                                <label
                                  htmlFor="endTime"
                                  className="ml-2 text-sm font-medium text-gray-700 mt-3"
                                >
                                  End Time:
                                </label>
                                <input
                  ...
                  <button
                    onClick={handleSave}
                    className="bg-green-500 text-white active:bg-green-600 font-bold uppercase text-xs px-8 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150 block mx-auto"
                    type="button"
                  >
                    Save
                  </button>
