  ...
  return (
    <>
      ...
      <section className="video-section py-32 md:px-16 lg:px-48 text-center">
        ...
        <p className="my-6 text-gray-500 text-1xl lg:px-10">Our curated network of accomplished mentors across diverse fields offers tailored support, actionable advice, and the inspiration you need to reach new heights in your career.</p>
      ...
      <section className="info-section p-40 md:p-20 lg:p-40 px-36 h-2/4 text-center text-white backdrop-blur-sm">
        ...
        <p className="px-36 w-3/4 md:w-full lg:w-3/4 text-center mx-auto block">With knowledgeable mentors, we hope to assist you in developing an incredible career.
